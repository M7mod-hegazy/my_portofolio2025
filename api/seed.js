...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (!existingAbout) {
      await About.create({
        content: `I'm Mahmoud Hegazi, an Electronics & Telecommunications Engineer with a passion for modern web development and innovative engineering solutions. I specialize in creating scalable applications and solving complex technical challenges.
